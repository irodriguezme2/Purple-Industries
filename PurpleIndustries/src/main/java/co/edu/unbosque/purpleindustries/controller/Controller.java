			...
			try {
				...
				case 1:
					try {
						...
						Paciente nuevo = new Paciente(nombre, fechaDeNacimiento, documento, email, altura, peso, rh, 1,
								"Sin registrar");
				...
				case 2:
					...
					try {
						...
						Doctor nuevo = new Doctor(nombre, fechaDeNacimiento, documento, email, especialidad);
				...
				case 3:
					...
					Paciente nuevo = new Paciente(nombre, fechaDeNacimiento, documentoPaciente1, email, altura, peso,
							rh, 1, "Sin registrar");
				...
				case 4:
					...
					while (true) {
						con.imprimirConSalto("Seleccionar el documento para actualizar 😷🤒🧑🏼");
						con.imprimirConSalto(mf.getPacienteDAO().mostrarTodo());
					...
					Doctor nuevo1 = new Doctor(nombre1, fechaDeNacimiento2, documentoDoctor1, email2, especialidad);
